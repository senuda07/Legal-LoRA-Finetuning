...
input = "results/lora_mistral24B_results/lora_mistral24B_summaries_test_chunked"
output = "results/lora_mistral24B_results/lora_mistral24B_summaries_test_merged"
