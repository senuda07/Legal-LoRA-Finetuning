...
input = "results/lora-dpo_mistral24B_results/lora-dpo_mistral24B_summaries_test_chunked"
output = "results/lora-dpo_mistral24B_results/lora-dpo_mistral24B_summaries_test_merged"
...
for doc_id, chunks in documents.items():
    ...
    output_path = os.path.join(output, f"{doc_id}.txt")
